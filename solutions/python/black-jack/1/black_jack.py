...
def value_of_ace(card_one, card_two):
    ...
    current_total_value+=value_of_card(card_one)+value_of_card(card_two)
    return 1 if 21-current_total_value<11 else 11
...
def is_blackjack(card_one, card_two):
    ...
    """
    if card_one=="A" or card_two=="A":
        return value_of_card(card_one)+value_of_card(card_two)+10==21
...
def can_double_down(card_one, card_two):
    ...
    num_list=[9, 10, 11]
    return value_of_card(card_one)+value_of_card(card_two) in num_list
