...
def get_leftover_of_bills(amount, denomination):
    ...
    """
    num_of_bills=get_number_of_bills(amount, denomination)
    return amount-(num_of_bills*denomination)
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    """
    rate_after_spread=exchange_rate+(exchange_rate*spread/100)
    money_exchanged=exchange_money(budget, rate_after_spread)
